## Purpose
This repository is a Jekyll-based static website for Valenspara (Turkish). These instructions give an AI coding agent the minimal, actionable knowledge needed to be productive while editing the site.
...
If anything here is unclear or you want me to expand any section (for example, more examples of front-matter fields or JS behavior), tell me which part to expand.
